...
function quoteGenerator(){
  ...
  document.getElementById('quote').innerHTML= JSON.stringify(quotes[index].quote)
  document.getElementById('author').innerHTML= `<i>` + JSON.stringify(quotes[index].source) + `</i>` 
} 
